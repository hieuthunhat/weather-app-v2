...
import {
    CLOUD_COVER,
    DOMINANT_WIND_DIRECTION, FEELS_LIKE_TEMPERATURE, IS_DAY, PRECIPITATION,
    PRECIPITATION_SUM, RAIN_SUM, RELATIVE_HUMIDITY, SHOWERS, SHOWERS_SUM, SNOWFALL, SNOWFALL_SUM,
    SUNRISE,
    SUNSET, TEMPERATURE,
    TEMPERATURE_MAX,
    TEMPERATURE_MIN, UV_INDEX_MAX, WEATHER_CODE, WIND_DIRECTION, WIND_GUSTS,
